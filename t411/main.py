...
class t411(TorrentProvider, MovieProvider):
    ...
    urls = {
        'test' : 'https://t411.lv',
        'login' : 'https://api.t411.lv/auth',
        'login_check': 'https://api.t411.lv/torrents/top/100',
        'detail' : 'https://www.t411.lv/torrents/?id=%s',
        'search' : 'https://api.t411.lv/torrents/search/%s?limit=200&cid=631',
        'download' : 'https://api.t411.lv/torrents/download/%s',
    }
